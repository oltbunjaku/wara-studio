  ...
  const products = [
    {
      ...
      collection: 'Drop 001',
      status: 'available',
      colours: ['Weathered White', 'Ink Black', 'Sun-Faded Red'],
      sizes: ['XS', 'S', 'M', 'L', 'XL'],
    ...
    },
    {
      ...
      status: 'available',
      colours: ['Golden Mustard', 'Sail Cream'],
      sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
      ...
      collection: 'Field Notes',
      status: 'available',
      colours: ['Sun-Faded Red', 'Sail Cream'],
      sizes: ['S', 'M', 'L', 'XL'],
      ...
      images: [
        'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=1400&q=86',
    ...
    },
    {
      ...
      collection: 'Field Notes',
      status: 'coming-soon',
      colours: ['Deep Ocean', 'Weathered White'],
      sizes: ['One Size'],
